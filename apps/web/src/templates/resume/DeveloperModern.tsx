                    ...
                    {project.keywords.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-2">
                        {project.keywords.map((kw, i) => (
                          <span
                            key={i}
                            className="px-2 py-0.5 bg-slate-100 text-xs text-gray-600 rounded"
                          >
                            {kw}
                          </span>
                        ))}
                ...
                {skills.map((skill, idx) => (
                  <div key={idx}>
                    ...
                    {skill.keywords.length > 0 && (
                      <p className="text-xs text-gray-600 mt-0.5">{skill.keywords.join(", ")}</p>
                    )}
                  </div>
                ))}
              </div>
            ...
            <section className="mb-5">
              ...
              <div className="space-y-2">
                {certifications.map((cert, idx) => (
                  <div key={idx}>
                    <h3 className="font-medium text-sm text-gray-800">{cert.name}</h3>
